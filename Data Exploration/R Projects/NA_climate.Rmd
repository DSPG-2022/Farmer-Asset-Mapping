...
```{r}
# multi-layered GeoTIFF
tif_test <- raster("bcsdNMME_forecastAnom_tmp2m_NMME_1MonthLead_3MosAvgs.tif")
...
```{r}
# ggplot() +
#     geom_raster(data = df , aes(x = x, y = y, fill = bcsdNMME_forecastAnom_tmp2m_NMME_1MonthLead_3MosAvgs)) +
